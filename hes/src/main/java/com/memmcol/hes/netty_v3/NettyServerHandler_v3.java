...
@Slf4j
public class NettyServerHandler_v3 extends SimpleChannelInboundHandler<byte[]> {
    ...
    public NettyServerHandler_v3(RequestResponseService clientService) {
...
//        if (!NettyServerHolder.isRunning()) {
//            log.info("🔁 Auto-restarting Netty on meter contact");
//            nettyHolder.restart(port, initializer);
//        }
    }
